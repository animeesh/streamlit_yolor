...
def load_yolor_and_process_each_frame( enable_webcam, vid_name, enable_GPU, confidence,
                                      assigned_class_id, kpi1_text, kpi2_text, kpi3_text, stframe):
    if enable_webcam:
        vid_name = '0'
    ...
    out, source, weights, save_txt, imgsz, cfg = \
        'inference/output', vid_name, 'yolor_p6.pt', False, 320, 'cfg/yolor_p6.cfg'
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        kpi3_text.write(f"<h1 style='text-align: center; color: red;'>{w}</h1>", unsafe_allow_html=True)
